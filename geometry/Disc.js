...
function Disc() {
    ...
    for (var i = 0; i < this.numTriangles; i++){
        ...
        this.vTexCoords[i*3] = vec2(0, 0);
        this.vTexCoords[i*3 + 1] = vec2(Math.cos(angle1)/2, Math.sin(angle1)/2);
        this.vTexCoords[i*3+2] = vec2(Math.cos(angle2)/2, Math.sin(angle2)/2);

        //  this.vTexCoords[i*3] = vec2(0, 0);
        // this.vTexCoords[i*3 + 1] = vec2(0, angle1/(2 * Math.PI));
        // this.vTexCoords[i*3+2] = vec2(0, angle2/(2 * Math.PI));
