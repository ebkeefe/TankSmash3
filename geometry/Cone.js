...
function Cone() {
    ...
    for (var i = 0; i < discTriangles; i++){
        ...
        this.vTexCoords[i*6] = vec2(0, 0);
        this.vTexCoords[i*6 + 1] = vec2(Math.cos(angle1)/2, Math.sin(angle1)/2);
        this.vTexCoords[i*6+2] = vec2(Math.cos(angle2)/2, Math.sin(angle2)/2);
        ...
        this.vTexCoords[i*6 + 3] = vec2(1, 0);
        this.vTexCoords[i*6 + 4] = vec2(0, angle2/(2 * Math.PI));
        this.vTexCoords[i*6+5] = vec2(0, angle1/(2 * Math.PI));
